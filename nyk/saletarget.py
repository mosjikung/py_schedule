...
def WEB_90100010610_OE():
  ...
  sql = """ DELETE FROM WEB_90100010610_OE WHERE EXTRACT(year FROM SO_NO_DATE) >= 2022 """
  # sql = """ DELETE FROM WEB_90100010610_OE WHERE EXTRACT(year FROM SO_NO_DATE) = 2022 and EXTRACT(month FROM SO_NO_DATE) = 8 """
...
def EXPORT_OE_ACTUAL():
  ...
  sql = """ DELETE FROM EXPORT_OE_ACTUAL """
  cursor.execute(sql)
