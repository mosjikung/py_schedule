...
def GET_PO_RM1():
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M01')      
     except Exception  as err:
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M02')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M03')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M04')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M05')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M06')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M07')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M08')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M09')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M10')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M11')
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyis", password="nyis", dsn=my_dsn)
     ...
     try:    
        ...
        cursor.callproc('INSERT_PO_DAILY_830M12')
