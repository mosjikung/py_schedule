  ...
  conn = cx_Oracle.connect(user="nyg1", password="nyg1", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
         ...
         ##get customer fg wcs auto
        cursor.callproc('Get_Master_Customer')

        ##sendLine("Start Procerdures Auto Update Cost WCS  (WCS G1,G3,G5)")
        args = ['G1','G1WCSACC0001','AUTO_UPD_COST_ACC_BY_CUT']
        result_args = cursor.callproc('QVD_RUN_INS_LOG', args)
        cursor.callproc('AUTO_UPD_COST_ACC_BY_CUT')
        args = ['G1','G1WCSACC0001',cursor.rowcount]
  ...
  conn = cx_Oracle.connect(user="nyg3", password="nyg3", dsn=my_dsn)
     ...
     try:    
       ...
       ##get customer fg wcs auto
        ...
        args = ['G3','G1WCSACC0001','AUTO_UPD_COST_ACC_BY_CUT']
        result_args = cursor.callproc('QVD_RUN_INS_LOG', args)
        ##sendLine("Start Procerdures Auto Update Cost WCS  (WCS G1,G3,G5)")
        cursor.callproc('AUTO_UPD_COST_ACC_BY_CUT')
        args = ['G3','G1WCSACC0001',cursor.rowcount]
        result_args = cursor.callproc('QVD_RUN_upd_LOG', args)
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyg_pho", password="nyg_pho", dsn=my_dsn)
     ...
     try:    
        ...
        args = ['G2','G1WCSACC0001','AUTO_UPD_COST_ACC_BY_CUT']
        result_args = cursor.callproc('QVD_RUN_INS_LOG', args)
        cursor.callproc('AUTO_UPD_COST_ACC_BY_CUT')              
        args = ['G2','G1WCSACC0001',cursor.rowcount]
        result_args = cursor.callproc('QVD_RUN_upd_LOG', args)
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyg4", password="nyg4", dsn=my_dsn)
     ...
     try:    
        ...
        args = ['G4','G1WCSACC0001','AUTO_UPD_COST_ACC_BY_CUT']
        result_args = cursor.callproc('QVD_RUN_INS_LOG', args)
        cursor.callproc('AUTO_UPD_COST_ACC_BY_CUT')
        args = ['G4','G1WCSACC0001',cursor.rowcount]
        result_args = cursor.callproc('QVD_RUN_upd_LOG', args)
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyg1", password="nyg1", dsn=my_dsn)
     ...
     try:    
        ...
        args = ['G5','G1WCSACC0001','AUTO_UPD_COST_ACC_BY_CUT']
        result_args = cursor.callproc('QVD_RUN_INS_LOG', args)  
        cursor.callproc('AUTO_UPD_COST_ACC_BY_CUT')
        args = ['G5','G1WCSACC0001',cursor.rowcount]
        result_args = cursor.callproc('QVD_RUN_upd_LOG', args)
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyg1", password="nyg1", dsn=my_dsn)
     ...
     try:    
        ...
        args = ['G6','G1WCSACC0001','AUTO_UPD_COST_ACC_BY_CUT']
        result_args = cursor.callproc('QVD_RUN_INS_LOG', args)
        cursor.callproc('AUTO_UPD_COST_ACC_BY_CUT')
        args = ['G6','G1WCSACC0001',cursor.rowcount]
        result_args = cursor.callproc('QVD_RUN_upd_LOG', args)
 ...
 try:
  ...
  conn = cx_Oracle.connect(user="nyg1", password="nyg1", dsn=my_dsn)
     ...
     try:    
        ...
        args = ['G7','G1WCSACC0001','AUTO_UPD_COST_ACC_BY_CUT']
        result_args = cursor.callproc('QVD_RUN_INS_LOG', args)
        cursor.callproc('AUTO_UPD_COST_ACC_BY_CUT')
        args = ['G7','G1WCSACC0001',cursor.rowcount]
        result_args = cursor.callproc('QVD_RUN_upd_LOG', args)
