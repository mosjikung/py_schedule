...
def GET_PO_RM2():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M02  ')
...
def GET_PO_RM3():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M03  ')        
...
def GET_PO_RM4():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M04  ')        
...
def GET_PO_RM5():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M05  ')        
...
def GET_PO_RM6():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M06  ')        
...
def GET_PO_RM7():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M07  ')        
...
def GET_PO_RM8():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M08  ')        
...
def GET_PO_RM9():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M09  ')        
...
def GET_PO_RM10():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M10  ')        
...
def GET_PO_RM11():
 try:
  ...
  conn = cx_Oracle.connect(user="nygm", password="nygm", dsn=my_dsn)
     ...
     try:    
        cursor = conn.cursor()
        print('Start Run  QVD_INS_BILL_OF_MATERIALS_M11  ')        
